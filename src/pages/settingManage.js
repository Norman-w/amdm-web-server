...
import {WhatsAppOutlined, UserOutlined, AntDesignOutlined,QuestionCircleOutlined} from '@ant-design/icons';
          ...
          <div className={classesName.partContent}>
            ...
            <Tooltip title="联系客服" placement="top">
              <div onClick={() => {
                ...
                <WhatsAppOutlined style={{fontSize: '16px', color: '#08c', userSelect: 'none', cursor: 'pointer'}}/>
              </div>
            </Tooltip>
          </div>
        </div>
